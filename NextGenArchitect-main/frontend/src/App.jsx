...
// Floorplan generation pages
import GenerateNewMap from './pages/GenerateNewMap.jsx';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<UserLayout />}>
            ...
            <Route path="generate-floor-plan" element={<GenerateFloorPlan />} />
            {/* Floorplan Generation Pages */}
            <Route path="generate-new-map" element={<GenerateNewMap />} />

  ...
  const loadPlots = async () => {
    try {
      ...
      const transformedPlots = plotsData.map(plot => ({
        ...
        area: plot.area || 'N/A',
        dimension_x: (plot.dimension_x !== undefined && plot.dimension_x !== null && plot.dimension_x !== '') ? plot.dimension_x : 'N/A',
        dimension_y: (plot.dimension_y !== undefined && plot.dimension_y !== null && plot.dimension_y !== '') ? plot.dimension_y : 'N/A',
        dimensions: (plot.dimension_x !== undefined && plot.dimension_x !== null && plot.dimension_x !== '') && (plot.dimension_y !== undefined && plot.dimension_y !== null && plot.dimension_y !== '') ? `${plot.dimension_x}ft x ${plot.dimension_y}ft` : 'N/A',
